    ...
    <Modal visible={visible} animationType="slide" transparent>
      <View
        ...
        <View className="bg-white overflow-hidden rounded-xl w-[90%] p-4 shadow-lg relative">
          ...
          <View className="absolute left-[-14] top-[69%] -translate-y-1/2">
          ...
          <View className="bg-gray-100 p-3 rounded-lg">
            <Text className="text-gray-700 font-semibold">
              {bookingInfo.from} ➡️ {bookingInfo.to}
            </Text>
          ...
          <View className="mt-3">
            ...
            <Text className="text-lg font-bold mt-2 text-green-600">
              PKR {bookingInfo.fare}
            </Text>
          </View>
          <TouchableOpacity className="bg-red-500 flow-row gap-2 p-3 rounded-lg mt-4 justify-center items-center">
